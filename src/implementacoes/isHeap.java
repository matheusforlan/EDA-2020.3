...
import java.util.Scanner;
	...
	public class isHeap {
		...
		public static void main(String[] args) {
			...
			String arrayInicial = Arrays.toString(sequenciaInteiros);
	       ...
	       if(isHeap(arrayInicial, heap.toString())) {
		...
		private static boolean isHeap(String arrayInicial, String heapBuilded) {
			
			return arrayInicial.equals(heapBuilded);
		}
